...
parser.add_argument("--output_dir", type=str, default="./save_models1_synapse", help="output dir")
...
parser.add_argument("--test_save_dir", type=str, default="../predictions1", help="saving prediction as nii!")
