...
parser.add_argument('--root_path', type=str,
                    default='/home/hutao/VesselSeg-Pytorch-master/model1/ACDC', help='root dir for data')
parser.add_argument('--dataset', type=str,
                    default='ACDC', help='experiment_name')
parser.add_argument('--list_dir', type=str,
                    default='/home/hutao/BRAU-Netplusplus-master/acdc_train_test/lists_ACDC', help='list dir')
...
if __name__ == "__main__":
    ...
    dataset_config = {
        'ACDC': {
            'root_path': '/home/hutao/VesselSeg-Pytorch-master/model1/ACDC',
    ...
    snapshot_path = "../model1/{}/{}".format(args.exp, 'TU')
