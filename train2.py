...
parser.add_argument(
    "--root_path",
    type=str,
    default="/home/hutao/VesselSeg-Pytorch-master/data1/Synapse/train_npz",
    help="root dir for train data",
)
parser.add_argument(
    "--test_path",
    type=str,
    default="/home/hutao/VesselSeg-Pytorch-master/data1/Synapse/test_vol_h5",
    help="root dir for test data",
)
parser.add_argument("--dataset", type=str, default="Synapse", help="experiment_name")
parser.add_argument("--list_dir", type=str, default="/home/hutao/VesselSeg-Pytorch-master/lists/lists_Synapse", help="list dir")
parser.add_argument("--num_classes", type=int, default=9, help="output channel of network")
parser.add_argument("--output_dir", type=str, default="./save_model3", help="output dir")
